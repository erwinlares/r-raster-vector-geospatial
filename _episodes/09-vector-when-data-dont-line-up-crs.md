...
> > 
> > ~~~
> > Reading layer `Boundary-US-State-NEast' from data source `/home/travis/build/UW-Madison-DataScience/r-raster-vector-geospatial/_episodes_rmd/data/vector/Boundary-US-State-NEast.shp' using driver `ESRI Shapefile'
